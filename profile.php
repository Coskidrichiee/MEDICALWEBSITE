    ...
    <ul class="d-flex align-items-center">
        <li class="nav-item dropdown pe-3">
            <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                <img src="img/my logo.png" alt="Upload Profile picture" class="rounded-circle">
...
<!-- End of Inventory nav       -->
  ...
  <main id="main" class="main">
    ...
    <img src="<?php echo htmlspecialchars($profileImage); ?>" alt="Profile picture" class="rounded-circle" id="profileImagePreview"> <!-- Show the profile image -->
    <h5><?php echo isset($_SESSION['username']) ? htmlspecialchars($_SESSION['username']) : 'Guest'; ?></h5>
    <p class="text-muted" id="overviewJob"></p>
...
<div class="row">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-8 col-lg-9">
            <img id="profileImagePreview" src="assets/img/my logo.png" alt="Upload Profile picture" class="img-thumbnail mb-2" style="width: 100px; height: 100px;">
...
<script>
  // Function to save profile data including image upload
function saveProfileData(event) {
    event.preventDefault(); // Prevent form submission

    const formData = new FormData(document.getElementById('profileForm'));
    const profileImageFile = formData.get('profileImage'); // Uploaded file
    ...
    if (profileImageFile) {
        const reader = new FileReader();
        reader.onload = function(e) {
            localStorage.setItem('profileImage', e.target.result); // Save to localStorage (or send to server)
            document.getElementById('profileImagePreview').src = e.target.result; // Update preview
        };
        reader.readAsDataURL(profileImageFile);
    } else {
        document.getElementById('profileImagePreview').src = 'assets/img/default.jpg'; // Default image if no upload
    }
}
